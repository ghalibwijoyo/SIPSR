...
@section ('title', 'Manajemen Pengguna — ArsiPSR')
...
@section ('content')
        ...
        >
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    Password baru:
                    <code
                        class="fs-6 px-2 py-1 bg-white border text-dark rounded user-select-all"
                        id="newPasswordText"
                        >{{ session('new_password_info')['password'] }}</code
                    >
                    <button
                        type="button"
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-0">
                        ...
                        @forelse ($users as $user)
                            <tr>
                                ...
                                <td class="px-4 py-3 text-end text-nowrap">
                                    <button
                                        type="button"
                                        class="btn btn-sm btn-light btn-icon text-primary me-1"
                                        data-bs-toggle="modal"
                                    ...
                                    <button
                                        type="button"
                                        class="btn btn-sm btn-light btn-icon text-warning me-1"
                                        data-bs-toggle="modal"
            ...
            @if ($users->hasPages())
                <div
                    class="card-footer bg-white border-top py-3 d-flex justify-content-center align-items-center w-100"
                >
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center pb-4">
                        <div class="mb-3">
                            <i
                                class="bi {{ $user->is_active ? 'bi-exclamation-triangle text-danger' : 'bi-check-circle text-success' }} fs-1"
                            ></i>
                        </div>
...
@push ('scripts')
    <script>
        function copyPassword() {
            const passwordText =
                document.getElementById("newPasswordText").innerText;
