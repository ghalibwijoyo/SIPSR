        ...
        <div class="col-md-4 mb-4">
            <div class="card border-0 shadow-sm text-center h-100">
                <div class="card-body py-5">
                    <div
                        class="d-inline-flex justify-content-center align-items-center bg-primary bg-opacity-10 text-primary rounded-circle mb-3"
        ...
        <div class="col-md-8 mb-4">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body pt-0">
                    <form
                        action="{{ route('profil.update-nama') }}"
                        method="POST"
                    >
                        @csrf
                        @method ('PUT')
                    ...
                    >
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <small class="form-text text-muted"
                                    >Minimal 8 karakter, harus mengandung huruf
                                    dan angka.</small
                                >
                            </div>
                        </div>
