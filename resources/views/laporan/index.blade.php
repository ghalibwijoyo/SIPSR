            ...
            <div class="col-12 mt-2">
                <div class="d-flex flex-wrap gap-2">
                    <a href="{{ route('laporan.index') }}" 
                       class="btn btn-sm {{ !request()->has('search') && !request()->has('category_id') && !request()->has('bank_id') && !request()->has('uploader_id') && !request()->has('tanggal_dari') ? 'btn-success' : 'btn-outline-success' }}"
