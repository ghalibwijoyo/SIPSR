...
@section('title', 'Halaman Tidak Ditemukan (404) — SIPSR')

@section('content')
<div class="container d-flex flex-column justify-content-center align-items-center min-vh-100 text-center py-5">
    <div class="mb-4">
        <div class="d-inline-flex justify-content-center align-items-center bg-secondary bg-opacity-10 text-secondary rounded-circle p-4 mb-3">
    ...
    <p class="text-muted mb-4 mx-auto" style="max-width: 500px;">
        Maaf, halaman atau dokumen yang Anda cari mungkin telah dihapus, dipindahkan, atau alamat URL yang Anda masukkan salah.
    </p>
