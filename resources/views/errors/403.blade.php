...
@section ('content')
    ...
    >
        <div class="mb-4">
            <div
                class="d-inline-flex justify-content-center align-items-center bg-danger bg-opacity-10 text-danger rounded-circle p-4 mb-3"
            >
        ...
        <p class="text-muted mb-4 mx-auto" style="
                max-width: 500px;
            ">Maaf, akun Anda tidak memiliki hak akses (role: <strong>ADMIN</strong>) untuk melihat halaman ini. Jika ini adalah kesalahan, silakan hubungi Administrator.</p>
        <a
