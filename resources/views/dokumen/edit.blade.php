...
@section('title', 'Edit Dokumen — SIPSR')
...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
    <div>
        ...
        <p class="text-muted mb-0">
            ...
            <a href="{{ route('dokumen.show', $dokumen) }}" class="text-decoration-none">{{ Str::limit($dokumen->nama_dokumen, 30) }}</a>
            <i class="bi bi-chevron-right mx-1 small"></i>
            Edit
        </p>
    </div>
    <a href="{{ route('dokumen.show', $dokumen) }}" class="btn btn-outline-secondary">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0 fw-semibold">
                    <i class="bi bi-pencil-square me-2 text-sipsr-primary"></i>Edit Metadata
                </h5>
                <span class="badge bg-secondary">
                    <i class="bi bi-file-earmark me-1"></i>{{ $dokumen->file_name }}
                </span>
            </div>
            <div class="card-body p-4">
                ...
                <div class="alert alert-info border-0 mb-4" role="alert">
                    ...
                    Hanya metadata yang dapat diedit. File dokumen tidak dapat diganti.
                </div>

                <form method="POST" action="{{ route('dokumen.update', $dokumen) }}" id="edit-form">
                    @csrf @method('PUT')
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                                      ...
                                      placeholder="Deskripsi dokumen (opsional)">{{ old('deskripsi', $dokumen->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                        ...
                        <button type="submit" class="btn btn-success px-4" id="btn-save-edit">
