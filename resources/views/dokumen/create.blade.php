...
@section ('title', 'Upload Dokumen — ArsiPSR')
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom py-3">
                    <h5 class="card-title mb-0 fw-semibold">
                        <i
                            class="bi bi-cloud-arrow-up me-2 text-sipsr-primary"
                        ></i
                        >Form Upload
                    </h5>
                </div>
                    ...
                    @if (session('warning_duplikat'))
                        ...
                        >
                            ...
                            <div>
                                ...
                                Nomor ini sudah digunakan dokumen lain. Klik
                                <strong>Upload</strong> sekali lagi untuk tetap
                                menyimpan.
                            </div>
                        </div>
                    @endif
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input
                                    ...
                                    placeholder="Contoh: SM/001/PSR/2026"
                                    required
                                />
                                @error ('nomor_dokumen')
                            ...
                            <div class="col-12">
                                ...
                                <div class="mt-2 d-none" id="file-info">
                                    <div
                                        class="d-flex align-items-center gap-2 p-2 bg-light rounded"
                                    >
                                        <i
                                            class="bi bi-file-earmark-pdf text-danger fs-4"
                                            id="file-icon"
                                        ></i>
                                        <div>
