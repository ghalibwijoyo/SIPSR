...
<aside class="sidebar d-flex flex-column" id="sidebar">
    ...
    <div class="sidebar-header px-3 py-3">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <small class="text-white-50 lh-1" style="font-size: 0.7rem"
                    >PSR Tanaman</small
                >
            </div>
        </div>
    ...
    <nav class="sidebar-nav flex-grow-1 overflow-auto px-2 py-3">
        <ul class="nav flex-column gap-1">
            ...
            <li class="nav-item">
                <a
                    class="nav-link sidebar-link {{ request()->is('dokumen*') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a
                    class="nav-link sidebar-link {{ request()->is('aktivitas*') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a
                    class="nav-link sidebar-link {{ request()->is('recycle-bin*') ? 'active' : '' }}"
            ...
            @if (auth()->user()->role === 'ADMIN')
                <li class="nav-item mt-3">
                    <small class="sidebar-label text-uppercase px-3"
                        >Admin</small
                    >
                </li>
                <li class="nav-item">
                    <a
                        class="nav-link sidebar-link {{ request()->is('admin/users*') ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a
                        class="nav-link sidebar-link {{ request()->is('admin/banks*') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a
                    class="nav-link sidebar-link {{ request()->is('profil*') ? 'active' : '' }}"
    ...
    {{-- Sidebar Footer --}}
    <div
        class="sidebar-footer px-3 py-3 border-top border-white border-opacity-10"
    >
        <div class="d-flex align-items-center">
