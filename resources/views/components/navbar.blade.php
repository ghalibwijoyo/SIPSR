{{-- Top Navbar --}}
<nav
    class="navbar navbar-expand-lg navbar-light bg-white border-bottom shadow-sm px-3 py-2"
    id="top-navbar"
>
    <div class="d-flex align-items-center w-100">
        {{-- Mobile Sidebar Toggle --}}
        <button
            class="btn btn-link text-dark d-lg-none me-2 p-0"
            type="button"
            id="sidebar-toggler"
        ...
        <div class="d-flex align-items-center gap-2">
            {{-- Role Badge --}}
            <span
                class="badge rounded-pill {{ auth()->user()->role === 'ADMIN' ? 'bg-sipsr-primary' : 'bg-secondary' }} px-3 py-2"
            >
            ...
            {{-- User Name --}}
            <span
                class="fw-semibold text-dark d-none d-sm-inline"
