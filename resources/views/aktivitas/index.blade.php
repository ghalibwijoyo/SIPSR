...
@section ('title', 'Log Aktivitas — ArsiPSR')

@section ('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Log Aktivitas Sistem</h1>
        @if(auth()->user()->role === 'ADMIN')
        <form action="{{ route('admin.aktivitas.empty') }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin mengosongkan seluruh log aktivitas? Tindakan ini tidak dapat dibatalkan.');">
            @csrf
            @method('DELETE')
            <button type="submit" class="btn btn-danger shadow-sm">
                <i class="bi bi-trash3-fill me-1"></i> Kosongkan Log
            </button>
        </form>
        @endif
    </div>
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-2">
                        ...
                        <div class="d-flex flex-wrap gap-2 ms-2">
                            ...
                            @if(request('milik_saya'))
                                <span class="badge rounded-pill bg-white text-dark border shadow-sm px-3 py-2 d-flex align-items-center gap-2">
                                    <span class="fw-normal"><i class="bi bi-person-fill text-sipsr-primary me-1"></i>Hanya Aktivitas Saya</span>
                                    <a href="{{ route('aktivitas.index', request()->except(['milik_saya', 'page'])) }}" class="text-muted hover-danger text-decoration-none">
                                        <i class="bi bi-x-circle-fill"></i>
                                    </a>
                                </span>
                            @endif
                            
                            @if(!empty(array_filter([request('search'), request('jenis_aktivitas'), request('user_id'), request('ip_address'), request('user_agent'), request('tanggal_dari'), request('tanggal_sampai'), request('milik_saya')])))
            ...
            >
                ...
                <div class="mb-4">
                    <div class="form-check form-switch form-check-inline">
                        <input class="form-check-input" type="checkbox" role="switch" id="filter_milik_saya_akt" name="milik_saya" value="1" {{ request('milik_saya') ? 'checked' : '' }}>
                        <label class="form-check-label fw-bold small text-dark" for="filter_milik_saya_akt">
                            Hanya Tampilkan Aktivitas Saya
                        </label>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    >
                        ...
                        @foreach ($jenisAktivitasList as $jenis)
                            <option
                                value="{{ $jenis }}"
                                {{ request('jenis_aktivitas') == $jenis ? 'selected' : '' }}
                            >
                                {{ str_replace('_', ' ', $jenis) }}
                            </option>
                        @endforeach
                ...
                <!-- Pengguna -->
                <div class="mb-4">
                    <label for="user_id" class="form-label small fw-bold"
                        >Pengguna</label
                    >
                ...
                <!-- IP Address -->
                <div class="mb-4">
                    <label for="ip_address" class="form-label small fw-bold"
                        >IP Address</label
                    >
                    <input
                        type="text"
                ...
                <!-- User Agent -->
                <div class="mb-4">
                    <label for="user_agent" class="form-label small fw-bold"
                    ...
                    <input
                        ...
                        placeholder="Contoh: Chrome atau Windows"
                    />
                </div>
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col-6">
                            ...
                            <input
                                ...
                                aria-label="Filter aktivitas dari tanggal"
                            />
                        </div>
                        <div class="col-6">
                            <label
                            ...
                            <input
                                ...
                                aria-label="Filter aktivitas sampai tanggal"
                            />
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <button
                            ...
                            onclick="
                                ...
                                return false;
                            "
                            aria-label="Filter aktivitas hari ini"
                        >
                            Hari Ini
                        </button>
                        <button
                            ...
                            onclick="
                                ...
                                return false;
                            "
                            aria-label="Filter aktivitas 1 minggu terakhir"
                        >
                            1 Minggu
                        </button>
                        <button
                            ...
                            onclick="
                                ...
                                return false;
                            "
                            aria-label="Filter aktivitas 1 bulan terakhir"
                        >
                            1 Bulan
                        </button>
                    </div>
                            ...
                            <tr>
                                <td colspan="7" class="p-4">
                                    ...
                                    >
                                        ...
                                        <ul class="mb-0">
                                            <li>
                                                Coba filter jenis aktivitas atau
