...
<div class="row g-3 mb-4">
    <div class="col-md-3">
        <a href="{{ route('dokumen.index') }}" class="text-decoration-none text-dark d-block h-100">
            <div class="card border-0 shadow-sm h-100 bg-white" style="transition: transform 0.2s ease;" onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='translateY(0)'">
    ...
    <div class="col-md-3">
        <a href="{{ route('dokumen.create') }}" class="text-decoration-none text-dark d-block h-100">
            <div class="card border-0 shadow-sm h-100 bg-white" style="transition: transform 0.2s ease;" onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='translateY(0)'">
                <div class="card-body d-flex align-items-center">
                    <div class="flex-shrink-0 me-3">
    ...
    <div class="col-md-3">
        @if(auth()->user()->role === 'ADMIN')
            <a href="{{ route('users.index') }}" class="text-decoration-none text-dark d-block h-100">
        @endif
            <div class="card border-0 shadow-sm h-100 bg-white" @if(auth()->user()->role === 'ADMIN') style="transition: transform 0.2s ease;" onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='translateY(0)'" @endif>
                <div class="card-body d-flex align-items-center">
                    <div class="flex-shrink-0 me-3">
                        ...
                        <tbody>
                            @forelse($latestActivities as $log)
                                <tr>
                                    ...
                                    <td><span class="text-muted small">{{ Str::limit($log->detail, 40) }}</span></td>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const baseColors = [
        ...
        '#6f42c1', '#17a2b8', '#28a745', '#e83e8c', '#343a40'
    ];
